...
tf.sg_arg_def(set=('train', "'train', 'valid', or 'test'.  The default is 'valid'"))
tf.sg_arg_def(frac=(0.01, "test fraction ratio to whole data set. The default is 1.0(=whole set)"))
